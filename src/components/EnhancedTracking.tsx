...
export default function EnhancedTracking() {
  ...
  // Note: Global window functions removed - use the useEnhancedTracking hook instead
...
export const useEnhancedTracking = () => {
  // Define tracking functions directly in the hook instead of relying on global window functions
  const trackEvent = (eventData: TrackingEvent) => {
